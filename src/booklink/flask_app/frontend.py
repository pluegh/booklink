...
def pair_ereader():
    ...
    return render_template(
        "simple_pair.html",
        client_expiration_seconds=current_app.config["APP_CONFIG"].client_expiration_seconds,
        poll_pairing_status_every=current_app.config["App_CONFIG"].poll_pairing_status_every,
    )
